                                ...
                                <x-filament::dropdown placement="bottom-end">
                                    ...
                                    <x-filament::dropdown.list>
                                        <x-filament::dropdown.list.item
                                            icon="heroicon-m-eye"
                                            tag="a" href="{{ \App\Filament\Pages\Hotels\Attractions\ViewAttraction::getUrl(['record' => $this->record, 'attraction_id' => $attraction['id']]) }}"
                                        >
                                            View
                                        </x-filament::dropdown.list.item>
                                        ...
                                        <x-filament::dropdown.list.item
                                            ...
                                            tag="a" href="{{ \App\Filament\Pages\Hotels\Attractions\EditAttraction::getUrl(['record' => $this->record, 'attraction_id' => $attraction['id']]) }}"
                                        >
                                            Edit
                                        </x-filament::dropdown.list.item>
                                        ...
                                        <x-filament::dropdown.list.item
                                            ...
                                            color="danger"
                                            wire:click="mountAction('deleteAttraction', { id: {{ $attraction['id'] }} })"
                                        >
                                            Delete
                                        </x-filament::dropdown.list.item>
                                    </x-filament::dropdown.list>
