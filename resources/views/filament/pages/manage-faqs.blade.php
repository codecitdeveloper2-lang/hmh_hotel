        ...
        <div style="width: 100%; min-width: 100%;" class="divide-y divide-gray-200 overflow-x-auto dark:divide-white/10">
            <table style="width: 100%; min-width: 100%; display: table;" class="fi-ta-table text-start divide-y divide-gray-200 dark:divide-white/5">
                <thead class="bg-gray-50 dark:bg-white/5">
                    <tr>
                        <th style="padding: 1rem 1.5rem; text-align: left;" class="text-sm font-semibold text-gray-950 dark:text-white">Question</th>
                        ...
                        <th style="padding: 1rem 1.5rem; text-align: left;" class="text-sm font-semibold text-gray-950 dark:text-white">Display Order</th>
                                ...
                                <x-filament::dropdown placement="bottom-end">
                                    ...
                                    <x-filament::dropdown.list>
                                        ...
                                        <x-filament::dropdown.list.item
                                            ...
                                            tag="a" href="{{ \App\Filament\Pages\Hotels\FAQs\EditFaq::getUrl(['record' => $this->record, 'faq_id' => $faq['id']]) }}"
                                        >
                                            Edit
                                        </x-filament::dropdown.list.item>
                                        ...
                                        <x-filament::dropdown.list.item
                                            ...
                                            color="danger"
                                            wire:click="mountAction('deleteFaq', { id: {{ $faq['id'] }} })"
                                        >
                                            Delete
                                        </x-filament::dropdown.list.item>
                                    </x-filament::dropdown.list>
