    ...
    <form wire:submit.prevent="save" style="width: 100%;">
        ...
        ">
            ...
            ">
                ...
                <div>
                    <div style="font-size: 1rem; font-weight: 600; color: inherit; letter-spacing: -0.01em;">Dining Details Content</div>
                    <div style="font-size: 0.75rem; opacity: 0.45; margin-top: 0.15rem;">Manage the frontend content displayed on the Dining Outlet Details page.</div>
                </div>
            </div>
