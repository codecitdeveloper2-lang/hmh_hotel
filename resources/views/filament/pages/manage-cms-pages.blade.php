        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1rem;">
            <x-filament::section>
                <div style="display: flex; align-items: center; gap: 1rem;">
                    ...
                    <div>
                        <p style="font-size: 0.875rem; font-weight: 500; opacity: 0.7; margin: 0;">Total Pages</p>
            ...
            <x-filament::section>
                <div style="display: flex; align-items: center; gap: 1rem;">
                    ...
                    <div>
                        ...
                        <h3 style="font-size: 1.5rem; font-weight: 700; margin: 0;">19</h3>
                    </div>
                </div>
            </x-filament::section>
            ...
            <div style="width: 100%; overflow-x: auto;">
                <table style="width: 100%; min-width: 900px; display: table; border-collapse: collapse; text-align: left;" class="fi-ta-table">
                    <thead style="border-bottom: 1px solid rgba(128,128,128,0.2);">
                        <tr>
                            <th style="padding: 1rem; font-size: 0.875rem; font-weight: 600; opacity: 0.8;">Page Banner</th>
                            <th style="padding: 1rem; font-size: 0.875rem; font-weight: 600; opacity: 0.8;">Page Title</th>
                            <th style="padding: 1rem; font-size: 0.875rem; font-weight: 600; opacity: 0.8;">Page Type</th>
                            <th style="padding: 1rem; font-size: 0.875rem; font-weight: 600; opacity: 0.8;">URL Slug</th>
                            <th style="padding: 1rem; font-size: 0.875rem; font-weight: 600; opacity: 0.8;">Status</th>
                            <th style="padding: 1rem; font-size: 0.875rem; font-weight: 600; opacity: 0.8;">SEO Enabled</th>
                    ...
                    <tbody style="font-size: 0.875rem;">
                        @forelse($pages as $page)
                            <tr style="border-bottom: 1px solid rgba(128,128,128,0.1); transition: background-color 0.15s ease-in-out;">
                                ...
                                <td style="padding: 1rem; opacity: 0.8; font-family: monospace;">
                                    /{{ $page['slug'] }}
                                </td>
                                <td style="padding: 1rem;">
                                ...
                                <td style="padding: 1rem;">
                                    @if($page['seo_enabled'])
                                        <x-filament::badge color="success" icon="heroicon-m-check-circle">Enabled</x-filament::badge>
                                    @else
                                        <x-filament::badge color="danger" icon="heroicon-m-x-circle">Disabled</x-filament::badge>
                                    @endif
                                </td>
                                <td style="padding: 1rem; opacity: 0.8;">
                                    {{ $page['last_updated'] }}
                                    ...
                                    <x-filament::dropdown placement="bottom-end" teleport>
                                        ...
                                        <x-filament::dropdown.list class="bg-white dark:bg-gray-800 shadow-xl border border-gray-200 dark:border-gray-700 rounded-lg" style="background-color: #1f2937;">
                                            ...
                                            <x-filament::dropdown.list.item
                                                ...
                                                tag="a" href="{{ \App\Filament\Pages\CmsPages\EditCmsPage::getUrl(['record' => $page['id']]) }}"
                                            >
                                                Edit
                                            </x-filament::dropdown.list.item>
                                            <x-filament::dropdown.list.item
                                                ...
                                                color="danger"
                                                wire:click="mountAction('deletePage', { id: {{ $page['id'] }} })"
                                            >
                                                Delete
                                            </x-filament::dropdown.list.item>
